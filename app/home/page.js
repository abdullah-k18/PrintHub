        ...
        >
          <SwiperSlide>
            <div className="h-full bg-white flex flex-col items-center justify-center text-black">
              ...
              <p className="mt-2 pr-5 pl-5 text-center">
                Discover a wide range of business essentials and personalized
                items.
              </p>
              <Link href="/products">
          ...
          <SwiperSlide>
            <div className="h-full bg-white flex flex-col items-center justify-center text-black">
              ...
              <p className="mt-2 pr-5 pl-5 text-center">
                Get the best quality printing solutions tailored for your needs.
              </p>
              <Link href="/presses">
                <button className="mt-4 px-6 py-2 bg-green-600 text-white rounded-lg shadow-md hover:bg-[#218838]">
                  Browse Presses
      ...
      <div className="mt-8 p-4 mb-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {categories.map((category, index) => (
            ...
            >
              <div className="flex flex-col items-center p-2 lg:p-4 bg-white shadow-md rounded-lg hover:shadow-lg transform hover:scale-105 transition-all cursor-pointer">
                <img
                  src={category.image}
                  alt={category.name}
